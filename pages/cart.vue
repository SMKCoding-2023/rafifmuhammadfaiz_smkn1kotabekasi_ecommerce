...
<template>
    ...
    <h1 class="text-3xl font-extrabold bg-amber-400 rounded-lg">Keranjang Belanja</h1>
    ...
    <div v-else>
    <h5 class="text-xl text-center font-bold">Keranjang Kosong</h5>
    </div>
    </div>
 
   <div class="center-container w-[30%] bg-white shadow-xl h-max p-6">
    ...
    <div v-else>
    <p class="text-sm text-center font-bold">There are no to
    orders yet</p>
    </div>
    </div>
